    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          { title: "Laba Bulan Ini", value: formatRupiah(data.labaKotor ?? 0), sub: `Bersih: ${formatRupiah(data.labaBersih ?? 0)}`, gradient: "from-blue-500 to-indigo-600", icon: TrendingUp },
